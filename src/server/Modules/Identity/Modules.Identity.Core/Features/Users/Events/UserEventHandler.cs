...
namespace InmoIT.Modules.Identity.Core.Features.Users.Events
{
        ...
        INotificationHandler<UserDeletedEvent>
    {
        ...
        {
            _logger.LogInformation(_localizer[$"{nameof(UserRegisteredEvent)} High."]);
            return Task.CompletedTask;
        }

        public Task Handle(UserUpdatedEvent notification, CancellationToken cancellationToken)
        {
            _logger.LogInformation(_localizer[$"{nameof(UserUpdatedEvent)} High."]);
            return Task.CompletedTask;
        }

        public Task Handle(UserDeletedEvent notification, CancellationToken cancellationToken)
        {
            _logger.LogInformation(_localizer[$"{nameof(UserDeletedEvent)} High. {notification.Id} Deleted."]);
            return Task.CompletedTask;
        }
    }
}