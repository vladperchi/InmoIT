// --------------------------------------------------------------------------------------------------
// <copyright file="CartItemUpdatedEvent.cs" company="InmoIT">
...
namespace InmoIT.Modules.Person.Core.Features.CartItems.Events
{
    public class CartItemUpdatedEvent : Event
    {
        ...
        public CartItemUpdatedEvent(CartItem cartItem)
        {
            Id = cartItem.Id;
            ...
            EventDescription = $"Updated Item Cart:{cartItem.PropertyId}:::Cart:{cartItem.CartId}:::Id:{cartItem.Id}";
        }
    }
}