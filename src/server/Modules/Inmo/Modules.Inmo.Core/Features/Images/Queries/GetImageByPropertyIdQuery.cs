// --------------------------------------------------------------------------------------------------
// <copyright file="GetImageByPropertyIdQuery.cs" company="InmoIT">
...
{
    public class GetImageByPropertyIdQuery : IRequest<Result<GetPropertyImageByPropertyIdResponse>>, ICacheable
    {
        ...
        public GetImageByPropertyIdQuery(Guid propertyId, bool skipCache = false, TimeSpan? expiration = null)
        {
            Id = propertyId;
            SkipCache = skipCache;
